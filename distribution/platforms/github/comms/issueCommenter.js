...
exports.GitHubIssueCommenter = function (api) {
    ...
    return {
         ...
         * then return true.
         */
        updateStatus: function (passed, message, url) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, api.updateStatus(passed, message, url)];
        }); }); },
        /**
